...
Below explanation is very much related to project data collection, training & testing. In case someone don't want to follow those steps, I've shared the trained model in 'weights' folder.
